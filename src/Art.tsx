...
export default function Home() {
    ...
    const art = [
        ...
        {header: "Cosplay 2022", photo1: "IMG_0669.PNG", photo2: "IMG_1152.JPG", photo3: "3dmodel4.png", title1: "Holiday Matsuri 2022", title2: "Emblem for 2023", title3: "Crown for 2023", year: "2022"},
                ...
                <CardGroup>
                    <Card>
                        ...
                        <Card.ImgOverlay>
                            ...
                            <Card.Footer>
                            <small className="text-muted">Last updated: {a.year}</small>
                            </Card.Footer>
                        </Card.ImgOverlay>
                    </Card>
                    <Card>
